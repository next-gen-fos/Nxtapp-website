...
The Value of your money stays Intact
...
- Space Grotesk ---> usage "font-Space Grotesk"
...
A separate folder called `https` is created withing the app folder here, to make an **API** Call:

- create a new folder within the `https/api` dir
